...
//========================================================================
// This program evalutes the performance of SList<int>::push_front and
// SList<int>::reverse by running multiple trials and averaging the elapsed
// run times.
//
...
void print_help() {
  printf(
      "usage: ./slist-spoly-reverse-v1-eval <size>\n\n"
      "Evaluation program for SList<int>::push_front and SList<int>::reverse_v1\n\n"
